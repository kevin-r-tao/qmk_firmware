...
[_QWERTY] = {
  ...
  {KC_CAPS,LT(1,KC_A),KC_S,LT(3,KC_D), KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,LT(1,KC_SCOLON),KC_ENT},
...
[_NAV] = {
  ...
  {_______, _______, _______, KC_INS,  KC_DEL,  _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______},
...
[_LOCK] = {
  {TO(0),   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  {_______, TOR(1),  _______, TOR(3),  _______, _______, _______, _______, _______, _______, TOR(1),  TOR(6) },
  {TOR(5),  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},

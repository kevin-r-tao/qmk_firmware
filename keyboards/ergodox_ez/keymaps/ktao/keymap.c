...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(KC_ESCAPE,KC_1,KC_2,KC_3,KC_4,KC_5,KC_TRANSPARENT,KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,TT(1),KC_CAPSLOCK,LT(1,KC_A),KC_S,LT(4,KC_D),LT(3,KC_F),KC_G,KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,TT(2),KC_LCTL,KC_LGUI,KC_TRANSPARENT,KC_SPACE,KC_LALT,KC_INSERT,KC_DELETE,KC_PSCREEN,LALT(KC_LEFT),LCTL(LSFT(KC_R)),KC_PAUSE,KC_TRANSPARENT,KC_6,KC_7,KC_8,KC_9,KC_0,KC_BSPACE,TT(3),KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSLASH,KC_H,KC_J,KC_K,KC_L,LT(1,KC_SCOLON),KC_ENTER,TT(4),KC_N,KC_M,KC_COMMA,KC_DOT,LT(3,KC_SLASH),KC_RSHIFT,KC_SPACE,KC_LEFT,KC_DOWN,KC_UP,RCTL_T(KC_RIGHT),KC_HOME,KC_END,KC_PGUP,KC_PGDOWN,LALT(LSFT(KC_R)),LCTL(KC_SPACE)),

...
[_QWERTY] = {
  ...
  {KC_TAB,  LT(1,KC_A),KC_S,  LT(3,KC_D),LT(2,KC_F),KC_G,KC_H,    KC_J,    KC_K,    KC_L,LT(1,KC_SCOLON),KC_ENT},
 ...
 */
[_SYMBOLS] = {
  {TO(0),   KC_F11,  KC_F12,  KC_LCBR, KC_RCBR, KC_EXLM, KC_PLUS, KC_DQT,  KC_QUOT, KC_GRV,  KC_TILD, KC_DEL},
 ...
 */
[_NUMPAD] = {
  {TO(0),   _______, _______, _______, _______, _______, KC_NLCK, KC_P7,   KC_P8,   KC_P9,S(KC_PPLS), _______},

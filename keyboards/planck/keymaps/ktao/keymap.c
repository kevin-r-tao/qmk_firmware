 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Esc  |A(SYM)|   S  |D(NUM)|   F  |   G  |   H  |   J  |   K  |   L  |;(SYM)|Enter |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 ...
 */
[_SYM] = {
  {_______, KC_F11,  KC_F12,  KC_LCBR, KC_RCBR, KC_PIPE, KC_PLUS, KC_DQT,  KC_QUOT, KC_GRV,  KC_BSLS, KC_DEL},
  {TO(0),   _______, _______, KC_LPRN, KC_RPRN, KC_AMPR, KC_EXLM, KC_EQL,  KC_MINS, KC_GT,   _______, _______},
  {KC_CAPS, _______, _______, KC_LT,   KC_GT,   KC_UNDS, KC_AT,   KC_SLSH, KC_ASTR, KC_TILD, _______, _______},
  {_______, _______, _______, KC_LBRC, KC_RBRC, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},

/* Nav
 * ,-----------------------------------------------------------------------------------.
 * |      |      |      |MoWhlU|MoBtn5|      | PgUp | Home |  Up  | End  |      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | TO(0)|      |      |MoWhlD|MoBtn4|      | PgDn | Left | Down |Right |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      |      |      | Ins  | Del  | PrtSc| Pause|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
 ...
 */
[_NAV] = {
  {_______, _______, _______, KC_WH_U, KC_BTN5, _______, KC_PGUP, KC_HOME, KC_UP,   KC_END,  _______, _______},
  {TO(0),   _______, _______, KC_WH_D, KC_BTN4, _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______},
  {_______, _______, _______, _______, _______, _______, _______, KC_INS,  KC_DEL,  KC_PSCR, KC_PAUS, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
},
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | TO(0)|      | Accl0| Accl1| Accl2|      |MoWhlD| MoLft| MoDwn| MoLft|      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |    MoBtn1   |MoBtn2|      |      |      |      |
...
[_MOUSE] = {
  ...
  {TO(0),   _______, KC_ACL0, KC_ACL1, KC_ACL2, _______, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
